...
test_that("Albumin-corrected calcium for missing values is missing", {
  expect_equal(adjust_calcium_for_albumin(3, NA), NA)
  expect_equal(adjust_calcium_for_albumin(NA, 23), NA)
})
...
test_that("Glucose-corrected sodium for missing values is missing", {
  expect_equal(adjust_sodium_for_glucose(120, NA), NA)
  expect_equal(adjust_sodium_for_glucose(NA, 25), NA)
})
